...
class FPN_Resnet(Network):
  ...
  def _init_top_down(self):
    ...
    self.c2_lateral_conv = Conv2d(64 * self._resnet.block.expansion, self._lateral_channel,
                                     kernel_size=1, bias=True, stride=1, relu=False)
    self.c3_lateral_conv = Conv2d(128 * self._resnet.block.expansion, self._lateral_channel,
                                     kernel_size=1, bias=True, stride=1, relu=False)
    self.c4_lateral_conv = Conv2d(256 * self._resnet.block.expansion, self._lateral_channel,
                                     kernel_size=1, bias=True, stride=1, relu=False)
    self.c5_lateral_conv = Conv2d(512 * self._resnet.block.expansion, self._lateral_channel,
                                     kernel_size=1, bias=True, stride=1, relu=False)
    ...
    self.p4_conv = Conv2d(self._lateral_channel, self._lateral_channel,
                        kernel_size=3, bias=True, stride=1, same_padding=True, relu=False)
    ...
    self.p3_conv = Conv2d(self._lateral_channel, self._lateral_channel,
                        kernel_size=3, bias=True, stride=1, same_padding=True, relu=False)
    ...
    self.p2_conv = Conv2d(self._lateral_channel, self._lateral_channel,
                        kernel_size=3, bias=True, stride=1, same_padding=True, relu=False)
